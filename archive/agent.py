...
"Narendra Modi was the Prime Minister of India in 2024.
He began his third consecutive term on 9 June 2024."

Do not add unrelated information about the 2019 election,
future elections, or other Prime Ministers.
...
while True:
    ...
    try:
        ...
        if not messages:
            ...
            print(
                "Agent: I could not generate a response."
            )
